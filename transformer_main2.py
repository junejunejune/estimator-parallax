...
#    estimator = construct_estimator(flags_obj, params, schedule_manager)
    estimator = tf.estimator.Estimator(model_fn=get_model_fn(train_input_fn, is_chief,schedule_manager.batch_size, flags_obj), model_dir=flags_obj.model_dir, params=params, config=run_config)
