...
import functools
def get_experiment_fn(cluster, flags_obj, params, num_gpus, variable_strategy):
  def _experiment_fn(run_config, hparams):
    ...
    estimator = tf.estimator.Estimator(model_fn=get_model_fn(cluster, flags_obj.task_index, train_input_fn, params["batch_size"], flags_obj), model_dir=flags_obj.model_dir, params=params, config=run_config)
